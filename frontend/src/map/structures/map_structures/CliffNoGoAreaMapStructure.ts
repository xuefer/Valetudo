...
class CliffNoGoAreaMapStructure extends MapStructure {
    public static TYPE = "CliffNoGoAreaMapStructure";
    ...
    draw(ctxWrapper: Canvas2DContextTrackingWrapper, transformationMatrixToScreenSpace: DOMMatrixInit, scaleFactor: number): void {
        ...
        ctx.strokeStyle = "rgba(32, 0, 0, 0.75)";
    ...
    getType(): string {
        return CliffNoGoAreaMapStructure.TYPE;
    }
}

export default CliffNoGoAreaMapStructure;
